        ...
        ExchangeManager().postCreateTransaction(
            ...
            if jsonT.error != nil {
                DispatchQueue.main.async {
                    self.showRegularCustomAnnotation(message: "Failed to create an order. Please, try another exchange provider.", imageSystemName: "exclamationmark.triangle", imageColor: .systemOrange)
                }
